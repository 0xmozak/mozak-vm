...
// fn build_elf(dest: &mut File, crate_path: &str, elf_path: &str, glob_name:
// &str, uses_std: bool) {     // Use a dummy array for clippy, since not
// building the elf is faster than     // building the elf
...
fn main() {
    ...
    // let mut dest = File::create(dest_path).expect("failed to create
    // vars.rs");
