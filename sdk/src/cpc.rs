...
//     static ref global_transcript_tape:
// Mutex<Vec<crate::coretypes::CPCMessage>> = Mutex::new(Vec::new()); }
...
//     println!(
//         "native_global_transcript_add_message called for CPC
// message:\n{:#?}",         msg
//     );
...
//     if let Ok(mut guard) = global_transcript_tape.lock() {
//         // let raw_pointer: *const crate::coretypes::CPCMessage =
// guard.as_ptr();         // let serialized_bytes = rkyv::to_bytes::<_,
// 4096>(&guard).unwrap();         // write_to_file(file_template + ".bin",
// rkyv::to_bytes::<_,         // 4096>(&guard).unwrap());
//         write_to_file(
