...
impl OrderedEvents {
    ...
    #[allow(dead_code)]
    #[must_use]
    pub fn get_canonical_order_temporal_hints(
        &self,
    ) -> Vec<CanonicallyOrderedEventsWithTemporalHints> {
        ...
        canonical_ordering
            ...
            .map(|((canonical_event, _), idx)| {
                CanonicallyOrderedEventsWithTemporalHints(canonical_event, idx)
            })
