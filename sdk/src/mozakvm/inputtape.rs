...
// self.read_offset); In case we don't have enough bytes to read
// if read_bytes > remaining_buf {
// read_bytes = remaining_buf;
// }
//
// buf[..read_bytes]
// .clone_from_slice(&self.tape[self.read_offset..(self.read_offset +
// read_bytes)]);
//
...
// Two ways of accessing tape:
// - Safe `std::io` traits way
// - Unsafe non-std::io way
