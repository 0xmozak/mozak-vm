...
/// case is to be applied to the sum of the outputs of two instances of the
/// U32InterleaveGate.
///
...
impl UninterleaveToU32Gate {
    ...
    pub fn routed_wires_per_op() -> usize { 3 }
...
impl<F: RichField + Extendable<D>, const D: usize> Gate<F, D> for UninterleaveToU32Gate {
    ...
    fn num_constraints(&self) -> usize { self.num_ops * (Self::NUM_BITS + 1 + 2) }
...
{
    fn id(&self) -> String { format!("uninterleave_to_u32_{}_{}", self.row, self.i) }
