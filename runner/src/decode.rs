...
/// ```
/// # Errors
/// Errors if UNKNOWN opcode is found while decoding.
#[allow(clippy::too_many_lines)]
#[allow(clippy::module_name_repetitions)]
#[allow(clippy::similar_names)]
pub fn decode_instruction(pc: u32, word: u32) -> Result<Instruction, String> {
    ...
    if op == Op::UNKNOWN {
        log::debug!("UNKNOWN Op at pc {pc:?}");
        return Err(format!("UNKNOWN Op at pc {pc:?}"));
    }
