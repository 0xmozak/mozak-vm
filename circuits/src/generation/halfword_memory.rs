    ...
    fn generate_half_memory_trace() {
        ...
        assert_eq!(trace,
            prep_table(vec![
                ...
                [       1,     400,   1,      0,        0,       1,        0,        0,     400],// Memory Init: 400
                [       1,     400,   2,      1,        0,       0,        2,        1,     1],  // Operations:  400
                [       1,     400,   3,      0,        1,       0,        2,        1,     1],  // Operations:  400
                [       1,     401,   1,      0,        0,       1,        0,        0,     1],  // Memory Init: 401
                [       1,     401,   2,      1,        0,       0,        1,        1,     1],  // Operations:  401
                [       1,     401,   3,      0,        1,       0,        1,        1,     1],  // Operations:  401
                [       1,     402,   1,      0,        0,       1,        0,        0,     1],  // Memory Init: 402
                [       1,     403,   1,      0,        0,       1,        0,        0,     1],  // Memory Init: 403
                [       1,     500,   1,      0,        0,       1,        0,        0,     97], // Memory Init: 500
                [       1,     500,   4,      1,        0,       0,        4,        3,     1],  // Operations:  500
                [       1,     500,   5,      0,        1,       0,        4,        1,     1],  // Operations:  500
                [       1,     501,   1,      0,        0,       1,        0,        0,     1],  // Memory Init: 501
                [       1,     501,   4,      1,        0,       0,        3,        3,     1],  // Operations:  501
                [       1,     501,   5,      0,        1,       0,        3,        1,     1],  // Operations:  501
                [       1,     502,   1,      0,        0,       1,        0,        0,     1],  // Memory Init: 502
                [       1,     502,   1,      0,        0,       0,        0,        0,     1],  // padding
            ])
        );
    }
}
