    ...
    fn generate_half_memory_trace() {
        ...
        assert_eq!(
            ...
            prep_table(vec![
                ...
                [       1,     400,   2,      1,        0,       0,        2,      0,           0,             2],  // Operations:  400
                [       1,     400,   3,      0,        1,       0,        2,      0,           0,             1],  // Operations:  400
                [       1,     401,   0,      0,        0,       1,        0,      1,       inv(1),            0],  // Memory Init: 401
                [       1,     401,   2,      1,        0,       0,        1,      0,           0,             2],  // Operations:  401
                [       1,     401,   3,      0,        1,       0,        1,      0,           0,             1],  // Operations:  401
                ...
                [       1,     500,   4,      1,        0,       0,        4,      0,           0,             4],  // Operations:  500
                [       1,     500,   5,      0,        1,       0,        4,      0,           0,             1],  // Operations:  500
                [       1,     501,   0,      0,        0,       1,        0,      1,      inv(1),             0],  // Memory Init: 501
                [       1,     501,   4,      1,        0,       0,        3,      0,           0,             4],  // Operations:  501
                [       1,     501,   5,      0,        1,       0,        3,      0,           0,             1],  // Operations:  501
