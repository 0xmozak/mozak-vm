...
use crate::stark::utils::{trace_to_poly_values, trace_rows_to_poly_values};
...
pub fn generate_traces<F: RichField + Extendable<D>, const D: usize>(
    ...
    let bitwise_trace = trace_rows_to_poly_values(bitwise_rows.into_iter().map(Into::into).collect());
