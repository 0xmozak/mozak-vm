    ...
    fn generate_full_memory_trace() {
        ...
        assert_eq!(
            ...
            prep_table(vec![
                ...
                [       1,     600,   2,     1,         0,       0,       13,      0,           0,             2],  // Operations:  600
                [       1,     600,   3,     0,         1,       0,       13,      0,           0,             1],  // Operations:  600
                [       1,     601,   0,     0,         0,       1,        0,      1,       inv(1),            0],  // Memory Init: 601
                [       1,     601,   2,     1,         0,       0,       12,      0,           0,             2],  // Operations:  601
                [       1,     601,   3,     0,         1,       0,       12,      0,           0,             1],  // Operations:  601
                [       1,     602,   0,     0,         0,       1,        0,      1,      inv(1),             0],  // Memory Init: 602
                [       1,     602,   2,     1,         0,       0,       11,      0,           0,             2],  // Operations:  602
                [       1,     602,   3,     0,         1,       0,       11,      0,           0,             1],  // Operations:  603
                [       1,     603,   0,     0,         0,       1,        0,      1,      inv(1),             0],  // Memory Init: 603
                [       1,     603,   2,     1,         0,       0,       10,      0,           0,             2],  // Operations:  603
                [       1,     603,   3,     0,         1,       0,       10,      0,           0,             1],  // Operations:  603
                [       1,     700,   0,     0,         0,       1,        0,     97,     inv(97),             0],  // Memory Init: 700
                [       1,     700,   4,     1,         0,       0,        4,      0,           0,             4],  // Operations:  700
                [       1,     700,   5,     0,         1,       0,        4,      0,           0,             1],  // Operations:  700
                [       1,     701,   0,     0,         0,       1,        0,      1,      inv(1),             0],  // Memory Init: 701
                [       1,     701,   4,     1,         0,       0,        3,      0,           0,             4],  // Operations:  701
                [       1,     701,   5,     0,         1,       0,        3,      0,           0,             1],  // Operations:  701
                [       1,     702,   0,     0,         0,       1,        0,      1,      inv(1),             0],  // Memory Init: 702
                [       1,     702,   4,     1,         0,       0,        2,      0,           0,             4],  // Operations:  702
                [       1,     702,   5,     0,         1,       0,        2,      0,           0,             1],  // Operations:  703
                [       1,     703,   0,     0,         0,       1,        0,      1,      inv(1),             0],  // Memory Init: 703
                [       1,     703,   4,     1,         0,       0,        1,      0,           0,             4],  // Operations:  703
                [       1,     703,   5,     0,         1,       0,        1,      0,           0,             1],  // Operations:  703
                [       1,     703,   5,     0,         0,       0,        1,      0,           0,             0],  // padding
                [       1,     703,   5,     0,         0,       0,        1,      0,           0,             0],  // padding
                [       1,     703,   5,     0,         0,       0,        1,      0,           0,             0],  // padding
                [       1,     703,   5,     0,         0,       0,        1,      0,           0,             0],  // padding
                [       1,     703,   5,     0,         0,       0,        1,      0,           0,             0],  // padding
