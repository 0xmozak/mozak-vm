...
use super::columns::{
    ...
    COL_S_MUL, COL_S_REMU, COL_S_SLT, COL_S_SLTU, COL_S_SRL, COL_S_SUB, NUM_CPU_COLS,
};
...
pub const STRAIGHTLINE_OPCODES: [usize; 8] = [
    COL_S_ADD, COL_S_SUB, COL_S_DIVU, COL_S_MUL, COL_S_REMU, COL_S_SLT, COL_S_SLTU, COL_S_SRL,
];
