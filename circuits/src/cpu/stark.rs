...
use super::columns::{
    ...
    COL_RS1_SELECT, COL_RS2_SELECT, COL_S_ADD, COL_S_AND, COL_S_BEQ, COL_S_ECALL, COL_S_HALT,
    COL_S_OR, COL_S_SLT, COL_S_SLTU, COL_S_SUB, COL_S_XOR, NUM_CPU_COLS, COL_S_DIVU, COL_S_REMU, COL_S_SRL
};
use super::{add, bitwise, div, slt, sub};
...
pub const STRAIGHTLINE_OPCODES: [usize; 10] = [
    COL_S_ADD, COL_S_SUB, COL_S_AND, COL_S_OR, COL_S_XOR, COL_S_DIVU, COL_S_REMU, COL_S_SLT, COL_S_SLTU, COL_S_SRL,
];
