...
use super::columns::{
    ...
    COL_S_OR, COL_S_SLT, COL_S_SLTU, COL_S_SUB, COL_S_XOR, NUM_CPU_COLS,
};
use super::{add, bitwise, slt, sub};
...
pub const STRAIGHTLINE_OPCODES: [usize; 7] = [
    COL_S_ADD, COL_S_SUB, COL_S_AND, COL_S_OR, COL_S_XOR, COL_S_SLT, COL_S_SLTU,
];
