...
pub(crate) fn constraints<P: PackedField>(
    ...
    let sign1 = bit_to_sign(lv.op1_sign_bit);
    let sign2 = bit_to_sign(lv.op2_sign_bit);
    let product_sign = bit_to_sign(lv.product_sign);
