...
use mozak_sdk::common::types::{Poseidon2Hash, ProgramIdentifier, SelfCallExtendedProgramIdentifier, SelfCallExtensionFlag};
...
fn main() {
    ...
    mozak_sdk::add_identity(SelfCallExtendedProgramIdentifier(token_program, SelfCallExtensionFlag::default())); // Manual override for `IdentityStack`
