...
Examples contains cargo projects which generate ELF compatible with MozakVM. The target ISA is riscV with I and M extensions, described best in `.cargo/riscv32im-mozak-zkvm-elf.json`.
